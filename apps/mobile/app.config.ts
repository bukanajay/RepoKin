    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active RepoKin agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow RepoKin to connect to RepoKin servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow RepoKin to access your camera so you can scan pairing QR codes.",
